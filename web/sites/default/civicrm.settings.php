...
$civicrm_paths['civicrm.files']['url'] = 'https://ilas.ddev.site/sites/default/files/civicrm';
...
$civicrm_paths['civicrm.root']['url'] = 'https://ilas.ddev.site/modules/contrib/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://db:db@db:3306/ilas_civicrm?new_link=true');
  }
}
